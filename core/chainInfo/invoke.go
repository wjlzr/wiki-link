...
//query 		查询条件
//params		参数
func ChainInfoInvoke(method string, result interface{}, query map[string]interface{}, params ...interface{}) error {
	//获取地址链接
	url := toUrl(ChainInfoUrl[method], params...)
...
//获取数据
func getFromChainInfo(url string) ([]byte, error) {
